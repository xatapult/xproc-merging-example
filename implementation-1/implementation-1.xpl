<p:declare-step version="3.0" name="this"
  ...
  <p:file-create-tempfile delete-on-exit="false" suffix=".xml"/>
  ...
  <p:validate-with-xml-schema>
    <p:with-input pipe="city-ids@this"/>
  ...
  <p:xslt 
    ...
    <p:with-input pipe="template@this"/>
